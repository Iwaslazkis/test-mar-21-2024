...
export function AveryButton({totalClicks, updateTotal}: {totalClicks: number, updateTotal: Function}) 
{
...
export default function AveryContainer({ title="Avery's Container", backgroundColor='#AAAAAA', padding=25}: { title: string, backgroundColor: string, padding: number }) 
{
    ...
    return (
        <section className="AveryContainer" style={styles}>
            <h2>{title}</h2>
